...
def main():
    ...
    viz.line([[0.9], [0.9], [0.9]], [0], win='val_acc'+str(img_size), opts=dict(title='val_acc_'+str(img_size), legend=['CNRPark', 'PKLot', 'mydata']))
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():  # 表示测试过程不需要计算梯度信息
            ...
            viz.line([[epoch_acc], [epoch_acc2], [epoch_acc3]], [epoch], win='val_acc'+str(img_size), update='append')
